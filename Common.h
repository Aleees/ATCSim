...
#define ANGULARSPEED 2.10f //velocidad angular usual

#define MAX_ANGULARSPEED 0.40f //velocidad angular usual
#define MIN_ANGULARSPEED -0.40f //velocidad angular usual


#define MAX_ACELERATION 15
#define MIN_ACELERATION -15

#define COLLISION_DISTANCE 500.0f
